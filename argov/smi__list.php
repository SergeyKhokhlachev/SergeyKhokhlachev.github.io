      ...
      <?php include ("include/header-gray.html");?>
        ...
        <div class="container">
            ...
            <div class="col-xs-12">
              ...
              <div class="h1-and-tab pd-bottom-50">
                ...
                <ul class="tab-list">
                  ...
                  <li class="active"><a href="#">Материалы в СМИ</a></li>
          ...
          <div class="row">
            ...
            <div class="row">
              <ul class="list-news news-style-box news-style-box--border smi-style pd-bottom-30">
              <?php
                $i = 1;
                while ($i <= 9) {
                  $i++;
                  ...
                  <a href="#">
                    <div class="box-inner">
                      <div class="news-slider__bottom">
                        <div class="date">Коммерсантъ</div>
                        <div class="text"><span class="smi-style__main-title">Подготовлен перечень видов федерального государственного контроля и уполномоченных его осуществлять органов власти</span>
